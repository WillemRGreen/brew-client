    ...
    render() {
        return (
            <>
                ...
                <p>
                    You'll have to wet the filter inside the kalita, and add the grounds. Then you'll want to make a "bloom" with the coffee by adding the weight of the coffee's worth in water and waitin g30 seconds before adding anymore.
                </p>
                <p>
