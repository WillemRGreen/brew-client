    ...
    render() {
        return (
            <>
                ...
                <p>
                    Any automatic method is going to be the easiest way to brew coffee. 
                </p>
                <p>
